export const CategoryBarData = [
  ...
  const fillCategoryWithImages = (category, count) => {
    const categoryImages = [];
  
    for (let i = 1; i <= count; i++) {
      categoryImages.push({
        ImgSrc: `https://source.unsplash.com/200x200/?${category}&${i}`,
  ...
  BestOf.BeautyFoodsToys = fillCategoryWithImages("facial cream", 7);
  BestOf.WinterEssential = fillCategoryWithImages("winter clothes", 7);
  BestOf.WeddingsAndGifts = fillCategoryWithImages("wedding dress", 7);
